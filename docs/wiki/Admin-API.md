...
| `GET /admin/api/plugins/catalog/{id}/preview` | Download and fully verify the trusted catalog candidate, then return its manifest and semantic permission delta relative to the installed version without mutating plugin state. |
